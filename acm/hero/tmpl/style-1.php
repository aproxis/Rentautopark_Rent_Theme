                                    ...
                                    <div class="hero-messengers" id="<?php echo $uid; ?>-messengers">
                                        ...
                                        <a href="<?php echo htmlspecialchars($phoneLink); ?>" target="_blank" rel="noopener noreferrer"
                                           class="hero-messenger-link hero-messenger-phone" aria-label="Phone">
                                            ...
                                            <div class="hero-messenger-tooltip">Phone</div>
                                        </a>
                                        <?php endif; ?>
                                        ...
                                        <a href="<?php echo htmlspecialchars($whatsappLink); ?>" target="_blank" rel="noopener noreferrer"
                                           class="hero-messenger-link hero-messenger-whatsapp" aria-label="WhatsApp">
                                            ...
                                            <div class="hero-messenger-tooltip">WhatsApp</div>
                                        </a>
                                        <?php endif; ?>
                            ...
                            <div class="hero-mobile-messengers" id="<?php echo $uid; ?>-mobile-messengers" style="display:none;">
                                ...
                                <a href="<?php echo htmlspecialchars($viberLink); ?>" target="_blank" rel="noopener noreferrer"
                                   class="hero-mobile-messenger-link hero-mobile-messenger-viber" aria-label="Viber">
                                    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M11.398.002C9.473.028 5.331.344 3.014 2.467 1.294 4.177.693 6.698.623 9.82c-.06 3.11-.13 8.95 5.5 10.541v2.42s-.038.97.602 1.17c.79.25 1.24-.499 1.99-1.299l1.4-1.58c3.85.32 6.8-.419 7.14-.529.78-.25 5.181-.811 5.901-6.652.74-6.031-.36-9.831-2.34-11.551l-.01-.002c-.6-.55-3-2.3-8.37-2.32 0 0-.396-.025-1.038-.016z"></path></svg>
                                    Viber
                                </a>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="hero-avatars-row">
                                ...
                                <div class="hero-avatars">
                                    ...
                                    <div class="hero-avatar">
                                        <img src="<?php echo htmlspecialchars($photo); ?>" alt="Client" loading="lazy">
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                                <?php endif; ?>
