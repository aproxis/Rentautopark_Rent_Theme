...
<div class="item-page<?php echo $this->pageclass_sfx; ?> clearfix" itemscope itemtype="https://schema.org/Article">
...
<article itemscope itemtype="http://schema.org/Article">
  <meta itemscope itemprop="mainEntityOfPage"  itemType="https://schema.org/WebPage" itemid="https://google.com/article"/>
    ...
    <meta content="<?php echo HTMLHelper::_('date', $this->item->modified, 'c'); ?>" itemprop="dateModified">
  <?php } ?>

  <?php if(!$params->get('show_publish_date')) { ?>
    <meta content="<?php echo HTMLHelper::_('date', $this->item->publish_up, 'c'); ?>" itemprop="datePublished">
  <?php } ?>
  ...
  <span itemprop="author" style="display: none;">
    ...
    <span itemtype="https://schema.org/Organization" itemscope="" itemprop="publisher" style="display: none;">
      <span itemtype="https://schema.org/ImageObject" itemscope="" itemprop="logo">
        <img itemprop="url" alt="logo" src="<?php echo URI::base(); ?>/templates/<?php echo Factory::getApplication()->getTemplate() ?>/images/logo.png">
