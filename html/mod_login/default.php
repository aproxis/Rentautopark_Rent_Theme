...
<?php if ($type == 'logout') : ?>
	<form action="<?php echo Route::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form"
		...
		<div class="logout-button">
			<input type="submit" name="Submit" class="btn btn-primary btn-decor" value="<?php echo Text::_('JLOGOUT'); ?>"/>
	...
	<form action="<?php echo Route::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form">
		...
		<fieldset class="userdata">
				...
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-group">
						<span class="input-group-addon">
							<i class="fa fa-user tip" title="<?php echo Text::_('MOD_LOGIN_VALUE_USERNAME') ?>"></i>
						</span>
			...
			<div id="form-login-password" class="form-group">
				...
				<div class="input-group">
						<span class="input-group-addon">
							<i class="fa fa-lock tip" title="<?php echo Text::_('JGLOBAL_PASSWORD') ?>"></i>
						</span>
			...
			<div id="form-login-secretkey" class="form-group">
				...
				<div class="input-group">
					<span class="input-group-addon">
						<i class="fa fa-star hasTooltip" title="<?php echo Text::_('JGLOBAL_SECRETKEY'); ?>"></i>
					</span>
					<label for="modlgn-secretkey" class="element-invisible"><?php echo Text::_('JGLOBAL_SECRETKEY'); ?></label>
					<input id="modlgn-secretkey" type="text" name="secretkey" class="input form-control" tabindex="0" size="18" placeholder="<?php echo Text::_('JGLOBAL_SECRETKEY') ?>" />
				...
				<?php else: ?>
					...
					<input id="modlgn-secretkey" type="text" name="secretkey" class="input-small" tabindex="0" size="18" placeholder="<?php echo Text::_('JGLOBAL_SECRETKEY') ?>" />
				...
				<div id="form-login-remember" class="form-group">
					...
					<label for="modlgn-remember">
						<input id="modlgn-remember" type="checkbox"
							...
							value="yes"/> <?php echo Text::_('MOD_LOGIN_REMEMBER_ME') ?>
					</label>
					</div>
				</div>
			<?php endif; ?>
