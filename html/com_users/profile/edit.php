...
/*
 * ------------------------------------------------------------------------
 * JA Rent template - Profile Edit (full page)
 * AutoRent Figma Design — v2
 * Styles loaded from: css/profile-edit.css
 * ------------------------------------------------------------------------
 */
...
<div class="profile-edit<?php echo $this->pageclass_sfx; ?>">
    ...
    <form id="member-profile" action="<?php echo Route::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-actions">
            ...
            <a class="btn-danger" href="<?php echo Route::_('index.php?option=com_users&view=profile'); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
